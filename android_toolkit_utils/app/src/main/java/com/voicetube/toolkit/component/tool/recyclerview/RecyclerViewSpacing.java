package com.voicetube.toolkit.component.tool.recyclerview;
...
public class RecyclerViewSpacing extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewSpacing setRightSpacing(int right){
        this.right=right;
        return this;
    }

    public RecyclerViewSpacing setLeftSpacing(int left){
        this.left=left;
        return this;
    }
